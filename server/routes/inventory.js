...
router.get('/', function(req, res, next) {
  res.sendFile(path.resolve(__dirname, '../public/views/newitem.html'));
});
...
router.get('/', function(req, res) {
  // check if logged in
  res.send('meow')
  console.log('checking get inventory route');
...
router.post('/', function(req, res, next) {
  ...
  //   password: encryptLib.encryptPa ssword(req.body.password)
  // };
  var inventoryItem = {
    item: req.body.item,
    vendor_id: req.body.vendor,
    on_hand: req.body.number_on_hand,
    low_number: req.body.low_number,
    type: req.body.type,
    notes: req.body.notes
  }
  console.log('new inventoryItem:', inventoryItem);
